        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="lonyo-default-content">
                    ...
                    <p class="max-w616">Have a question? We have the answer. Whether you need technical support or want
                        to know more about this tool.</p>
                    <div class="mt-50">
                        <div class="lonyo-contact-us-info-item ">
                            <div class="lonyo-contact-us-icon">
                                <a href="mailto:name@email.com"><img src="assets/images/contact-us/email.svg"
                                        alt=""></a>
                            </div>
                        ...
                        <div class="lonyo-contact-us-info-item ">
                            <div class="lonyo-contact-us-icon">
                                <a href="mailto:name@email.com"><img src="assets/images/contact-us/phone.svg"
                                        alt=""></a>
                            </div>
                            <div class="lonyo-contact-us-content">
                                <a href="mailto:name@email.com">
            ...
            <div class="col-lg-5">
                <div class="lonyo-contact-box box2" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <form id="contactForm" action="{{ route('send.message') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="lonyo-main-field-textarea">
                            <textarea class="button-text" id="message" name="message" placeholder="Write your message here..."></textarea>
                        </div>
...
document.getElementById("contactForm").addEventListener("submit", function(e) {
    ...
    .catch(error => {
        if (error.errors) {
            // Validation errors
            let msg = Object.values(error.errors).flat().join('<br>');
